              ...
              {conversation.isGroup ? (
                conversation.avatarUrl ? (
                  <Avatar className="size-11">
                    <AvatarImage src={conversation.avatarUrl} alt={title} />
                    <AvatarFallback>{initials(title)}</AvatarFallback>
                  </Avatar>
                ) : (
                  <div className="flex size-11 shrink-0 items-center justify-center rounded-full bg-accent text-muted-foreground">
